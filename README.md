...
we:connect는 팀원 간의 원활한 소통과 효율적인 업무 관리를 지원하는 통합 플랫폼입니다. 출퇴근 기록, 업무 일지, 프로젝트 관리, 팀 현황 파악, 예약 시스템 등 다양한 기능을 하나의 애플리케이션에서 제공합니다. 이를 통해 팀원들은 협업을 강화하고 생산성을 높일 수 있습니다.

### 1.2 해결하고자 하는 문제

#### 반복되는 비효율적인 프로세스

출근 일정, 업무 일지 작성 등 위니브에서 반복적으로 수행되는 업무들이 있습니다. 잦은 변경이 발생하기 때문에 서로의 일정을 파악하는 데 어려움이 있습니다. 이를 자동화하고 간소화하여 팀원들이 핵심 업무에 집중할 수 있도록 지원합니다.

#### 분산된 도구 사용

현재 Discord, Notion, Flex 등 여러 도구를 사용하여 업무를 관리하고 있지만, 이로 인해 정보가 분산되고 소통이 원활하지 않은 문제가 발생하고 있습니다. we:connect는 이러한 문제를 해결하여 팀원들이 하나의 플랫폼에서 모든 업무를 관리할 수 있도록 지원합니다.

#### 팀원 간 연결

재택과 유연 근무제가 가능한 회사 특성상, 팀원간의 연결이 약화될 수 있습니다. we:connect는 팀원 간의 소통과 협업을 촉진하여 조직 문화를 강화하고, 팀원들이 서로 연결되어 있음을 느낄 수 있도록 지원합니다.
